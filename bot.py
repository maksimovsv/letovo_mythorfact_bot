...
quiz_data = [ 
    ...
    { 
        'question': 'В школе «Летово» организовано полноценное трехразовое питание.', 
        'answer': False, 
    ...
    { 
        'question': 'В школе «Летово» представлено восемь различных профильных направлений обучения.', 
        'answer': True, 
        'description': 'В Летово присутствует система ИУПов (индивидуальные учебные планы), что предоставляет ученикам выбор профиля из следующих предметов — математика, физика, информатика, экономика, химия, биология, иностранные языки, география, история, искусство, общество и литература. Но в Летово уже есть и готовые профильные направления — МатЭк, ФизМат, МатIT, МатITML (machine learning), ХимФиз, ХимБио, БиоХим, ФилОбщ, СоцЭк, ГеоИст, ФилArts, СоцГум.' 
    }, 
    { 
